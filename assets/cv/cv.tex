...
\hypersetup{
  ...
  urlcolor = black,
  pdfauthor = {\name},
  pdfkeywords = {physics, AdS/CFT, quantum gravity, quantum information, extended thermodynamics, holographic complexity, scrambling, computer science, graph alignment, graph matching, graph isomorphism, machine learning},
