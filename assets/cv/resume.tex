...
\subsubsection*{Graduate Student in Weinberg Theory Group under Prof. Willy Fischler \hfill August 2015 - Present}
 ...
 %       \item Formulate interesting and solvable problems, particularly related the AdS/CFT correspondence and it's intersection with quantum information theory.
%        \item Solve quantitative problems in a collaborative environment with software tools, especially Wolfram Mathematica.
%        \item Present findings to colleages through presentations both internally at UT and externally at conferences. 
...
%        \item Replaced hard drives, power supplies, memory sticks, etc. in %desktop computers.
%    \end{itemize}
